...
export function AmbientSound() {
  ...
  return (
    <button
      onClick={toggleSound}
      className={`fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-background/80 backdrop-blur-sm border-2 border-accent/50 flex items-center justify-center hover:bg-accent/20 transition-all duration-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
